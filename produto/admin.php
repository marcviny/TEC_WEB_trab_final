        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button onclick="window.location.href='./index.php'" onclick="$_SESSION['administrador'] = 'false'" style="background-color:blue;color:white;border-radius:10px;">Logout</button> 
