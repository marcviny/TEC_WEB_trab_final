        ...
        <div class="col-10">
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="rua-cliente" aria-describedby="ruaHelp" name="ruaCliente" value="<?php echo $retorno->rua_cliente; ?>">
                    <div id="ruaHelp" class="form-text"></div>
                </div>
                <div class="mb-3">
                    <label for="bairro" class="form-label">Bairro</label>
                    <input type="text" class="form-control" id="bairro-cliente" aria-describedby="bairroHelp" name="bairroCliente" value="<?php echo $retorno->bairro_cliente; ?>">
